...
UAT tells us WHAT is broken (symptoms). Diagnosis finds WHY (root cause). Then `/gsd-phase-plan --gaps` creates targeted fixes based on actual causes, not guesses.
