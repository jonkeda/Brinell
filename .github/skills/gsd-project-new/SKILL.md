...
**After this command:** Run `/gsd-phase-discuss 1` or `/gsd-phase-plan 1`.
...
Usage:
  /gsd-project-new --auto @your-idea.md
  /gsd-project-new --auto [paste or write your idea here]
...
use_tool(vscode_askQuestions, {
  questions: [{
    ...
    options: [
      { label: "Map codebase first", description: "Run /gsd-codebase-map to understand existing architecture", recommended: true },
...
If "Map codebase first": Tell user to run `/gsd-codebase-map` first, then return. Exit.
...
**Write config.json** using template at `.github/skills/gsd-project-new/templates/config.json`. Populate with user selections.
...
**If interactive:** Follow the questioning workflow detailed in `.github/skills/gsd-project-new/references/questioning-workflow.md`.
...
Synthesize all context into `.planning/PROJECT.md` using the template at `.github/skills/gsd-project-new/templates/project.md`.
...
Follow the research workflow in `.github/skills/gsd-project-new/references/research-workflow.md`.
...
Follow the requirements workflow in `.github/skills/gsd-project-new/references/requirements-workflow.md`.
...
**Generate REQUIREMENTS.md** using template at `.github/skills/gsd-project-new/templates/requirements.md`:
...
Follow the roadmap workflow in `.github/skills/gsd-project-new/references/roadmap-workflow.md`.
...
**Create ROADMAP.md** using template at `.github/skills/gsd-project-new/templates/roadmap.md`:
...
Create `.planning/STATE.md` using template at `.github/skills/gsd-project-new/templates/state.md`:
...
╚══════════════════════════════════════════╝
```
Invoke `/gsd-phase-discuss 1 --auto`.
...
/gsd-phase-discuss 1 — gather context and clarify approach
/gsd-phase-plan 1 — skip discussion, plan directly
```
