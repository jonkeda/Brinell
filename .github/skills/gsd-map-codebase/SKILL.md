...
- Write `{outputDir}/STACK.md` using `gsd_write_file` MCP tool with path `.planning/codebase/STACK.md` and content from template at `.github/skills/gsd-map-codebase/templates/codebase/STACK.md`
...
- Write `{outputDir}/ARCHITECTURE.md` using `gsd_write_file` MCP tool with path `.planning/codebase/ARCHITECTURE.md` and content from template at `.github/skills/gsd-map-codebase/templates/codebase/ARCHITECTURE.md`
...
- Write `{outputDir}/CONVENTIONS.md` using `gsd_write_file` MCP tool with path `.planning/codebase/CONVENTIONS.md` and content from template at `.github/skills/gsd-map-codebase/templates/codebase/CONVENTIONS.md`
...
- Write `{outputDir}/CONCERNS.md` using `gsd_write_file` MCP tool with path `.planning/codebase/CONCERNS.md` and content from template at `.github/skills/gsd-map-codebase/templates/codebase/CONCERNS.md`
