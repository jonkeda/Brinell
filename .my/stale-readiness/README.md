...
| [implementation-review-2.md](implementation-review-2.md) | A second, independent review at `d511793`: the first review's fixes re-checked, and 8 new findings | nothing; the findings |
| [review-2-fixes.md](review-2-fixes.md) | The design for answering those findings, what is deliberately not fixed, and how it is verified | **what to build for review 2** |
