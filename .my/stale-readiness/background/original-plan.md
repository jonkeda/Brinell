...
> **Background, superseded.** The current plan is [../plan.md](../plan.md), and the design is
> [../design.md](../design.md). Keep this for section 1 (the observed failure and the mechanism),
> and for decisions S1-S5. What changed since:
>
> - Phases 0-6 are replaced by plan.md steps 0-8.
> - Section 3.1's `NotVisibleException` became `ElementNotReadyException` with a reason.
> - Phase 4's container-root question became the alive rule (design R6).
> - The scope, collection, Core-interface and R0 work was added.
> - The "Related" list below predates the reorganization; use [../README.md](../README.md).
...
- Trace: [find-element-trace.md](find-element-trace.md), on the `FindElement`, `TryFindElement`
  ...
  surface.
- Scopes: [scopes-analysis.md](scopes-analysis.md), an analysis of the context, root scopes,
  pages, containers and collections, and how they fit together. Decisions Q1-Q10 are open.
- Review: [review.md](review.md), a critical look at complexity, overengineering and flakiness
  value. It recommends measuring first, then a narrow "tier 1" fix.
- Design: [design.md](../design.md), the overall class design covering all of the
  above, scopes included. [controls-design-v1.md](controls-design-v1.md), the first, controls-only design, is superseded.
