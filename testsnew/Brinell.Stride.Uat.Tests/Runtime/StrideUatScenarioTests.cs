...
[Trait("Category", "UAT")]
[Trait("Target", "STRIDE")]
public sealed class StrideUatScenarioTests : IDisposable
{
    private readonly StrideUatFixture _fixture = new();

    public static IEnumerable<object[]> ScenarioFiles => StrideUatScenarioSource.GetScenarioFiles();
