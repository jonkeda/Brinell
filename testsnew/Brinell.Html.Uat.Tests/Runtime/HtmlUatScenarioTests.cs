...
[Trait("Category", "UAT")]
[Trait("Target", "HTML")]
public sealed class HtmlUatScenarioTests : IDisposable
{
    private readonly HtmlUatFixture _fixture = new();

    public static IEnumerable<object[]> ScenarioFiles => HtmlUatScenarioSource.GetScenarioFiles();
