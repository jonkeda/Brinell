...
[Trait("Category", "UAT")]
[Trait("Target", "WPF")]
public sealed class WpfUatScenarioTests : IDisposable
{
    private readonly WpfUatFixture _fixture = new();

    public static IEnumerable<object[]> ScenarioFiles => WpfUatScenarioSource.GetScenarioFiles();
