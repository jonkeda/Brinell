...
public sealed class WinFormsUatScenarioTests : IDisposable
{
    private readonly WinFormsUatFixture _fixture = new();

    public static IEnumerable<object[]> ScenarioFiles => WinFormsUatScenarioSource.GetScenarioFiles();
