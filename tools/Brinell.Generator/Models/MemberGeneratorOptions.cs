...
/// <summary>
/// Configuration options for a member generator.
/// </summary>
public class MemberGeneratorOptions
{
    ...
    /// <summary>
    /// Gets or sets the name of the first parameter to skip when generating the public signature.
    /// Typically "element" for the platform element parameter.
    /// </summary>
