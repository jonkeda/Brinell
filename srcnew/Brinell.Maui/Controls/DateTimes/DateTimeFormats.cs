...
public static class DateTimeFormats
{
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to the current culture's short-date pattern, which is what the platform renders
    ...
    /// the culture's date and time separators, so <c>ToString("MM/dd/yyyy")</c> can produce
    /// <c>09-19-2026</c>. Use
