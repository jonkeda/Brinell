...
/// Inherits from MauiClickableControlBase to provide click capability.
/// Implements IExpandableControlObject with Expand, Collapse, ToggleExpanded.
/// </summary>
/// <typeparam name="TScope">The containing scope type for fluent chaining.</typeparam>
public class MauiExpandableControlBase<TScope> : MauiClickableControlBase<TScope>, IExpandableControlObject<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiExpandableControlBase(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiExpandableControlBase(IMauiScope<TScope> scope, string locatorValue)
