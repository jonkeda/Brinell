...
public class MauiScrollableControlBase<TScope> : MauiControlBase<TScope>, IScrollableControlObject<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiScrollableControlBase(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiScrollableControlBase(IMauiScope<TScope> scope, string locatorValue)
    ...
    protected virtual void ScrollToCore(IMauiElement element, Locator locator, int timeoutMs)
    {
        ...
        for (int i = 0; i < maxAttempts && stopwatch.ElapsedMilliseconds < timeoutMs; i++)
        {
            ...
            Thread.Sleep(100); // Brief pause for scroll to settle
        }
