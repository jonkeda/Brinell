...
public class MauiToolbarControl<TScope> : MauiControlBase<TScope>
    where TScope : IMauiScope<TScope>
{
    /// <summary>
    /// Creates a Toolbar control with locator.
    /// </summary>
    public MauiToolbarControl(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    /// </summary>
    public MauiToolbarControl(IMauiScope<TScope> scope, string automationId)
    ...
    {
        var toolbarItem = new MauiButtonControl<TScope>(MauiScope, itemLocator);
