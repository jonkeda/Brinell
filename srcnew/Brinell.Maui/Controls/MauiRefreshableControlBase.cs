...
public class MauiRefreshableControlBase<TScope> : MauiControlBase<TScope>, IRefreshableControlObject<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiRefreshableControlBase(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiRefreshableControlBase(IMauiScope<TScope> scope, string locatorValue)
