...
public class MauiSwipeableControlBase<TScope> : MauiControlBase<TScope>, ISwipeableControlObject<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiSwipeableControlBase(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiSwipeableControlBase(IMauiScope<TScope> scope, string locatorValue)
