...
public class MauiActivityIndicatorControl<TScope> : MauiControlBase<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiActivityIndicatorControl(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiActivityIndicatorControl(IMauiScope<TScope> scope, string locatorValue)
