...
public class MauiImageControl<TScope> : MauiControlBase<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiImageControl(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiImageControl(IMauiScope<TScope> scope, string locatorValue)
