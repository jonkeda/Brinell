...
public abstract class FocusableControlBase<TScope> : ControlBase<TScope>, IFocusableControlObject<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public FocusableControlBase(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public FocusableControlBase(IMauiScope<TScope> scope, string locatorValue)
