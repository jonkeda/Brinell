    ...
    where TPage : IPageObject
{
    ...
    /// <param name="scope">The element scope (page or container) for this control.</param>
...
/// <summary>
/// Base class for all MAUI controls implementing the Is/Wait/Assert pattern.
/// Controls find elements within their scope (page, container, or list item).
/// </summary>
public class MauiControlBase : IControlObject
{
    private readonly IMauiElementScope _scope;
    private readonly Locator _locator;
    ...
    /// <param name="scope">The element scope (page or container) for this control.</param>
    /// <param name="locator">The locator used to find the control element.</param>
    public MauiControlBase(IMauiElementScope scope, Locator locator)
    {
        _scope = scope ?? throw new ArgumentNullException(nameof(scope));
        _locator = locator ?? throw new ArgumentNullException(nameof(locator));
    }
    ...
    {
        IPageObject pageObject => pageObject,
        IContainerControl container => container.Page,
        _ => null
    };
