    ...
    where TItem : class
{
    ...
    {
        return Poll(() => GetPageInfoText() == expected, timeoutMs ?? DefaultTimeoutMs);
    }
    ...
    {
        return Poll(() => HasNextPage() == expected, timeoutMs ?? DefaultTimeoutMs);
    }
    ...
    {
        return Poll(() => HasPreviousPage() == expected, timeoutMs ?? DefaultTimeoutMs);
    }
