...
public class MauiClickableControlBase<TScope> : MauiControlBase<TScope>, IClickableControlObject<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiClickableControlBase(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public MauiClickableControlBase(IMauiScope<TScope> scope, string locatorValue)
