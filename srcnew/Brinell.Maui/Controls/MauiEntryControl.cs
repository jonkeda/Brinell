...
/// <summary>
/// MAUI Entry control with text input capability (non-generic version for backward compatibility).
/// </summary>
public class MauiEntryControl : MauiControlBase, IEditableTextControlObject
{
    /// <summary>
    /// Creates a new entry control within the specified scope.
    /// </summary>
    ...
    #region IEditableTextControlObject Implementation
