...
/// Inherits all scroll methods from ScrollableControlBase.
/// </summary>
/// <typeparam name="TScope">The containing scope type for fluent chaining.</typeparam>
public class ScrollView<TScope> : ScrollableControlBase<TScope>
    where TScope : IMauiScope<TScope>
{
    ...
    public ScrollView(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
    ...
    public ScrollView(IMauiScope<TScope> scope, string locatorValue)
