...
/// Inherits Expand, Collapse, Toggle, IsExpanded, AssertExpanded from MauiExpandableControlBase.
/// </summary>
    ...
    where TScope : IMauiScope<TScope>
{
    ...
    public MauiExpanderControl(IMauiScope<TScope> scope, Locator locator)
        : base(scope, locator)
    {
    }
