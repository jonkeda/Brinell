...
{
    /// <summary>
    /// Provides a strongly-typed variant of <see cref="System.Windows.Input.ICommand.CanExecute(object)"/>.
    /// </summary>
    ...
    /// <summary>
    /// Provides a strongly-typed variant of <see cref="System.Windows.Input.ICommand.Execute(object)"/>.
    /// </summary>
    /// <param name="parameter">The input parameter.</param>
    /// <remarks>Use this overload to avoid boxing, if <typeparamref name="T"/> is a value type.</remarks>
