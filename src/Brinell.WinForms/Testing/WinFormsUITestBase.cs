...
public abstract class WinFormsUITestBase : UITestBase<FlaUITestContext>
{
    ...
    /// <summary>
    /// Create a new WinForms UI test base with optional output writer.
    /// </summary>
    /// <param name="outputWriter">Action to write test output (e.g., xUnit's ITestOutputHelper.WriteLine).</param>
    protected WinFormsUITestBase(Action<string>? outputWriter = null) : base(outputWriter)
    {
    }
    ...
    /// <summary>
    /// Dispose WinForms-specific resources.
    /// </summary>
