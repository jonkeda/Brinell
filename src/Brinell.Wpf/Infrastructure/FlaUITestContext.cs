...
/// <summary>
/// FlaUI test context implementation for WPF UI testing.
/// Implements ITestContext for common operations, adds WPF-specific methods.
/// </summary>
public class FlaUITestContext : ITestContext
{
    ...
    #region WPF-specific element operations (direct FlaUI access)
    ...
    #region Element operations (WPF-specific, not part of ITestContext)
